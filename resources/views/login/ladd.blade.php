...
<body>
	...
	<div class="logDiv">
		...
		<div class="logGet">
			...
			<!-- 输入框 -->
			<form action="{{route('ladd_do')}}" method='post'>
			@csrf
			<div class="lgD">
				<img class="img1" src="../laravel/img/logName.png" /><input type="text"
					placeholder="输入用户名" name="name" />
			</div>
			<div class="lgD">
				<img class="img1" src="../laravel/img/logPwd.png" /><input type="text"
