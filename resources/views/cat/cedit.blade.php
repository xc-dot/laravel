	...
	<div id="pageAll">
		...
		<div class="page ">
			...
			<div class="banneradd bor">
				...
				<form action="{{url('cat/cupd/'.$data->cid)}}" method='post'>
				@csrf
				<div class="baBody">
					<div class="bbD">
						&nbsp;&nbsp;&nbsp;分类名称：<input type="text" class="input3" name='cname' value="{{$data->cname}}"/>
						@php echo $errors->first('uname'); @endphp
					</div>
					<div class="bbD">
					&nbsp;&nbsp;&nbsp;排序：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="order" class="input3" name="sort_order" value="{{$data->sort_order}}"/>
					</div>
