				...
				<div class="conform">
					<form>
						<div class="cfD">
							...
							<input class="addUser" type="text" name="name" value="{{$name}}" placeholder="请输入商品名称" />
				...
				<div class="conShow">
					<table border="1" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="305px" class="tdColor">商品名称</td>
							<td width="275px" class="tdColor">商品价格</td>
							<td width="275px" class="tdColor">图片</td>
							<td width="275px" class="tdColor">商品分类</td>
							<td width="275px" class="tdColor">商品品牌</td>
							<td width="315px" class="tdColor">商品数量</td>
						...
						<tr height="85px">
							...
							<td>
								<a href=" {{url('goods/gedit/'.$v->gid)}}">
									<img class="operation" src="../laravel/img/update.png">
								</a>
								<a href=" {{url('goods/gdel/'.$v->gid)}}">
