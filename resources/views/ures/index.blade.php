	...
	<div id="pageAll">
		...
		<div class="page ">
			...
			<div class="banneradd bor">
				...
				<form action="{{route('udo')}}" method='post'>
				@csrf
				<div class="baBody">
					<div class="bbD">
						&nbsp;&nbsp;&nbsp;用户名：<input type="text" class="input3" name='uname' />
					</div>
					<div class="bbD">
                    ...
                    <div class="bbD">
						&nbsp;&nbsp;&nbsp;&nbsp;用户身份：
                        <input type="radio" name='is_show' value='0'/>主管
                        <input type="radio"  name='is_show' value='1'/>库管员
					</div>
					<!-- <div class="bbD">
